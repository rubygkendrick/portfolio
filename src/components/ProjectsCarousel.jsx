...
const projects = [
  ...
  },
  {
    ...
    tags: ["React", "C#/.NET", "Entity Framework Core", "PostgreSQL 16"],
  },
  {
    name: "Stitches",
    ...
    <section className="section">
      <div className="section-header">
        ...
        <div className="carousel-arrows">
          <button onClick={() => scroll(-1)} className="arrow-btn">
            ←
          </button>
          <button onClick={() => scroll(1)} className="arrow-btn">
            →
